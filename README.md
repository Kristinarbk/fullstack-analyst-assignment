...
* **Спецификация требований:** Полный текст требований (User Story, Acceptance Criteria) и детальные варианты использования (Use Cases) оформлены в отдельном документе:
  👉 **[Открыть спецификацию требований в формате Markdown](./task2/use case.md)**
